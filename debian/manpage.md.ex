...
distcc - program to do something

# SYNOPSIS

**distcc** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**distcc** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **distcc** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**distcc** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    distcc. See **foo.conf**(5) for further details.
...
**distcc** provides some return codes, that can be used in scripts:
...
Chen Linxuan <black_desk@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Chen Linxuan
